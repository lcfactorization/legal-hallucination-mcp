...
def build_system_prompt(meta: SkillMeta) -> str:
    parts = [
        ...
        "每个维度——包括\"无幻觉\"维度——必须展开充分论证，论证义务不因检测结果为\"无幻觉\"而免除。",
        "- 无幻觉维度：(1) 检测过程说明 (2) 审查标准说明 (3) 论证依据 (4) 改进建议",
        "- 低风险幻觉维度：(1) 幻觉定位（原文段落/行号） (2) 幻觉性质分析 (3) 风险等级论证 (4) 改写建议 (5) 法条参照",
        "- 中高风险幻觉维度：(1) 幻觉定位 (2) 幻觉性质分析 (3) 风险等级论证 (4) 对其他维度的影响分析 (5) 详细改写建议 (6) 法条参照 (7) 救济路径建议",
        "",
        ...
        "报告生成后必须自检：每个维度至少1个深度论证callout；\"无幻觉\"维度有检测过程说明；Callout类型≥6种；模板套话占比<10%。",
        "",
